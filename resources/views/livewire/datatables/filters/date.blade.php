<div x-data class="flex flex-col">
    <div class="w-40 relative flex items-center">
        <input x-ref="start" class="min-w-0 h-7 pr-8 m-1 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="date"
    ...
    <div class="w-40 relative flex items-center">
        <input x-ref="end" class="min-w-0 h-7 pr-8 m-1 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="date"
